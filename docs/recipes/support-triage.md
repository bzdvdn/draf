...
Runnable:
[`examples/recipes/support_triage/`](../../examples/recipes/support_triage/) (the
compact supervisor + HITL version, offline-tested), plus the larger pieces it
composes:
[`examples/simple_router/`](../../examples/simple_router/) (the `route()`
...
- **RAG is a tool, not a step.** The knowledge base is exposed as a
  [`RAGTool`](../../../teff/rag/tool.py) so each specialist can ground answers
...
[`examples/simple_router/tests/`](../../examples/simple_router/tests/) and the
FastAPI tests in
[`examples/applications/repair-ai-chat/tests/`](../../examples/applications/repair-ai-chat/tests/).
