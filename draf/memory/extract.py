...
session.  It is a thin layer over a :class:`~draf.harness.loop.Harness`:
...
- ``save`` extracts facts and writes them into a
  :class:`~draf.memory.base.MemoryStore`, keyed by a stable hash of the
...
class MemoryExtractor:
    ...
    Args:
        harness: A :class:`~draf.harness.loop.Harness` used for the single
    ...
    async def save(
        ...
        *,
        ...
        Args:
            memory: A :class:`~draf.memory.base.MemoryStore`.
