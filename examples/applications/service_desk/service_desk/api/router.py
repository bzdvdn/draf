...
:mod:`service_desk.api.chat`, :mod:`service_desk.api.run`, :mod:`service_desk.api.auth`.
"""
...
from service_desk.api.auth.router import router as auth_router
from service_desk.api.chat.router import router as chat_router
from service_desk.api.run.router import router as run_router
