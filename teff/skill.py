...
# Core meta-skills shipped with teff.  These are framework-level behaviour
...
# disk.  All are namespaced with the ``teff-`` prefix to avoid colliding
# with user skills.
